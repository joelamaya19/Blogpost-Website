...
function toggleDarkTheme() {
    ...
    const elementsToToggle = document.querySelectorAll('.post-blog, input[type="text"], textarea, header, footer, body, .blogs-web-button, .back-button, .dark-theme-toggle, .footer-link');
